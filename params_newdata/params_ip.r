...
gfed	 %			GFED_4.1s_0.5deg	1997 		2016		20			1		linear			 coarsegrain
cld		 -			tcdc.eatm.gauss		2000		2015		1			1		linear			 bilinear
prev_ba	 %			GFED_4.1s_0.5deg	1997 		2016		20			1		prev_yearly		 coarsegrain
...
ftmap 		11 		bilinear		  forest_type/MODIS/ftmap_modis_SASplus_0.5deg_11levs_noMixed.nc
elev		1		bilinear		  util_data/elevation/elev.0.5-deg.nc
dft			1		bilinear		  forest_type/MODIS/dft_MODIS11lev_agri-bar_lt0.5_0.5deg.nc
pop			1		bilinear		  World_population_density/GHS_POP_GPW42000_GLOBE_R2015A_54009_1k_v1_0/GHS_pop_GPW42000_SSAplus_0.5deg.nc

> MASKS
# var	|	interp 			| file 
ftmask		bilinear 	  forest_type/MODIS/ftmask_MODIS_0.5deg.nc
